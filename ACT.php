...
$contentSql = "SELECT title, content, image_path FROM act_content LIMIT 1";
...
$bsisEvents = [];
$eventsSql = "SELECT event_date, title, description, location FROM act_events ORDER BY event_date ASC";
  ...
  <section class="hero-section">
    ...
    <section class="events-section">
        <div class="events-container">
            <h2 class="section-title">ACT Program Events</h2>
