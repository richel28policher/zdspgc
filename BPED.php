...
$bsisContent = ['title' => '', 'content' => '', 'image_path' => ''];
$contentSql = "SELECT title, content, image_path FROM bped_content LIMIT 1";
...
$bsisEvents = [];
$eventsSql = "SELECT event_date, title, description, location FROM bped_events ORDER BY event_date ASC";
  ...
  <section class="hero-section">
    ...
    <section class="events-section">
        <div class="events-container">
            <h2 class="section-title">BPED Program Events</h2>
