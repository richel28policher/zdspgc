...
$fetchSql = "SELECT title, content, image_path FROM employment LIMIT 1";
...
<body style="background-color: white;">
    ...
    <header class="header-top">
        <div class="header-container">
            ...
            <div class="college-title">
                ...
                <div class="campus-name">DIMATALING CAMPUS <?php echo !empty($heroData['image_path']) ? htmlspecialchars($heroData['image_path']) : ''; ?></div>
            </div>
        </div>
  ...
  <?php include('main-nav.php'); ?> 
     ...
     <section class="hero-section">
        ...
        <h1 class="hero-title" style="text-align: left; !important">Employment <br></h1>
      ...
      <section class="instructors-section">
        <div class="instructors-container">
           <h1 class="section-title"><center><?php echo !empty($heroData['title']) ? htmlspecialchars($heroData['title']) : ''; ?></center></h1>
