...
$fetchSql = "SELECT title, content, image_path, handbookname, file_path FROM handbook_content LIMIT 1";
     ...
     <section class="hero-section">
      ...
      <section class="instructors-section">
        <div class="instructors-container">
            <h3 class="section-title"><center> <?php echo !empty($heroData['title']) ? htmlspecialchars($heroData['title']) : ''; ?></center></h3>
...
<br>
<center>
<a href="admin/<?php echo !empty($heroData['file_path']) ? $heroData['file_path'] : ''; ?>" style="
...
" target="_blank">
   <?php echo !empty($heroData['handbookname']) ? htmlspecialchars($heroData['handbookname']) : ''; ?>
</a>
