...
$heroData = ['title' => '', 'content' => '', 'image_path' => '', 'emergency_plan_path' => '', 'emergency_content' => ''];
$fetchSql = "SELECT title, content, image_path, emergency_plan_path, emergency_content FROM safety_security_content LIMIT 1";
    ...
    position: relative;
        ...
        .hero-section {
           ...
           background: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.1)), 
                url('admin/<?php echo !empty($heroData['image_path']) ? htmlspecialchars($heroData['image_path']) : ''; ?>') center/cover;
            display: flex;
            align-items: center;
     ...
     <section class="hero-section">
      ...
      <section class="instructors-section">
        <div class="instructors-container">
            <h3 class="section-title"><center> <?php echo !empty($heroData['title']) ? htmlspecialchars($heroData['title']) : ''; ?>
</center></h3>
 <div class="section-description">
        <?php echo !empty($heroData['content']) ? $heroData['content'] : ''; ?>
    </div>

<img src="admin/<?php echo !empty($heroData['emergency_plan_path']) ? $heroData['emergency_plan_path'] : ''; ?>" style="width: 100%;">
	  
<div class="section-description">
        <?php echo !empty($heroData['emergency_content']) ? $heroData['emergency_content'] : ''; ?>
    </div>
	</div>
