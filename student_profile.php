...
$contentSql = "SELECT title, content, image_path FROM student_profile LIMIT 1";
...
// Fetch board members
$boardMembers = [];
$membersSql = "SELECT id, name, designation, details, image_path FROM student_members";
...
<body style="background-color: white;">
  ...
  <?php include('main-nav.php'); ?> 
     ...
     <section class="hero-section">
        <h1 class="hero-title">Zamboanga del Sur Provincial Government College – Dimataling Campus</h1>
    </section>
