...
$fetchSql = "SELECT title, content, image_path FROM student_profile LIMIT 1";
...
<body style="background-color: white;">
  ...
  <?php include('main-nav.php'); ?> 
    ...
    <h1 class="section-title"><?php echo !empty($heroData['title']) ? htmlspecialchars($heroData['title']) : ''; ?></h1>
