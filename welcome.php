...
<body style="background-color: white;">
  ...
  <?php include('main-nav.php'); ?> 
    ...
    <section class="content-section">
        <h1 class="section-title">Welcome to Zamboanga del Sur Provincial Government College – Dimataling Campus
</h1>
        <p class="section-description">
         Zamboanga del Sur Provincial Government College – Dimataling Campus is a proud public institution of higher learning dedicated to providing accessible, affordable, and quality college education to students in Dimataling and neighboring communities. <br><br>
At our campus, we currently offer the following degree programs: <br>
* Bachelor of Science in Information Systems (BSIS) <br>
* Associate in Computer Technology (ACT)<br>
